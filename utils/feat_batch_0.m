function [scores, list_im]= feat_batch_0 (use_gpu, net_model, net_weights, list_im, root_folder)
caffe.reset_all();
if nargin < 1
  % By default use CPU
  use_gpu = 0;
...
for bb = 1 : num_batches
    ...
    tic
    input_data = {prepare_batch(list_im(range), root_folder, mean_data, batch_size)};
    toc, tic
